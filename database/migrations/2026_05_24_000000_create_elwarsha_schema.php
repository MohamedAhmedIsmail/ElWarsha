...
SQL);
    ...
    {
        DB::statement('SET FOREIGN_KEY_CHECKS=0;');
        DB::statement('DROP TABLE IF EXISTS `static_pages`;');
        DB::statement('DROP TABLE IF EXISTS `app_settings`;');
        DB::statement('DROP TABLE IF EXISTS `complaint_media`;');
        ...
        DB::statement('DROP TABLE IF EXISTS `device_tokens`;');
        DB::statement('DROP TABLE IF EXISTS `featured_placements`;');
        ...
        DB::statement('DROP TABLE IF EXISTS `workshop_analytics_events`;');
        DB::statement('DROP TABLE IF EXISTS `lead_status_logs`;');
        DB::statement('DROP TABLE IF EXISTS `lead_notes`;');
        DB::statement('DROP TABLE IF EXISTS `leads`;');
        DB::statement('DROP TABLE IF EXISTS `service_ledger_media`;');
        DB::statement('DROP TABLE IF EXISTS `service_ledgers`;');
        DB::statement('DROP TABLE IF EXISTS `vehicle_maintenance_reminders`;');
        DB::statement('DROP TABLE IF EXISTS `maintenance_items`;');
        DB::statement('DROP TABLE IF EXISTS `reviews`;');
        DB::statement('DROP TABLE IF EXISTS `emergency_guidance_requests`;');
        DB::statement('DROP TABLE IF EXISTS `sos_request_logs`;');
        DB::statement('DROP TABLE IF EXISTS `sos_requests`;');
        DB::statement('DROP TABLE IF EXISTS `sos_provider_services`;');
        DB::statement('DROP TABLE IF EXISTS `sos_providers`;');
        DB::statement('DROP TABLE IF EXISTS `sos_service_types`;');
        DB::statement('DROP TABLE IF EXISTS `booking_status_logs`;');
        DB::statement('DROP TABLE IF EXISTS `bookings`;');
        DB::statement('DROP TABLE IF EXISTS `diagnosis_workshop_suggestions`;');
        DB::statement('DROP TABLE IF EXISTS `diagnosis_media`;');
        DB::statement('DROP TABLE IF EXISTS `diagnoses`;');
        DB::statement('DROP TABLE IF EXISTS `symptoms`;');
        DB::statement('DROP TABLE IF EXISTS `workshop_verifications`;');
        DB::statement('DROP TABLE IF EXISTS `workshop_working_hours`;');
        DB::statement('DROP TABLE IF EXISTS `workshop_images`;');
        DB::statement('DROP TABLE IF EXISTS `workshop_brands`;');
        DB::statement('DROP TABLE IF EXISTS `workshop_services`;');
        DB::statement('DROP TABLE IF EXISTS `workshops`;');
        DB::statement('DROP TABLE IF EXISTS `services`;');
        DB::statement('DROP TABLE IF EXISTS `service_categories`;');
        DB::statement('DROP TABLE IF EXISTS `vehicles`;');
        DB::statement('DROP TABLE IF EXISTS `car_models`;');
        DB::statement('DROP TABLE IF EXISTS `car_brands`;');
        DB::statement('DROP TABLE IF EXISTS `user_consents`;');
        DB::statement('DROP TABLE IF EXISTS `otp_codes`;');
